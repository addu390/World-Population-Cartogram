...
sns.scatterplot(x="SP.POP.TOTL", y="qty_sq", hue="hasTri", data=cellQty, ax=ax1, legend=False,
                palette=["#34495e", "#2ecc71"], linewidth=0, size=1.5)
plt.xscale("log")
plt.yscale("log")
...
sns.scatterplot(x="SP.POP.TOTL", y="qty_sqtri", hue="hasTri", data=cellQty, ax=ax2, legend=False,
                palette=["#34495e", "#2ecc71"], linewidth=0, size=1.5)
plt.xscale("log")
plt.yscale("log")
